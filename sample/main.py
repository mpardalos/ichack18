...
with open('raw.csv', 'w') as csvfile:
    ...
    spamwriter.writerow(['Age', 'Gender', 'Group Type', 'Nationality', 'Country', 'Movie', 'Rating'])

    for i in range(100):
        spamwriter.writerow([random.randrange(ageLower, ageUpper),
                             random.choice(gender),
                             random.choice(groupType),
                             random.choice(nationality),
                             random.choice(countries)[1],
                             random.choice(movies),
                             random.randrange(scoreMax) + 1])